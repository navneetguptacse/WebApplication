        ...
        <div class="container col-md-4">
            ...
            <%
                ...
                try{
                    ...
                    String sql = "update record set name='"+name+"',age="+age+",address='"+address+"' where id="+id+"";
                    int ans = st.executeUpdate(sql);
                    if(ans!=0){
                        out.println("<br><br>Record updated...");
                    } else {
                        out.println("<br><br>Sorry, No such record exist !!");
                    }
                    con.close();
                } catch(Exception e) {
